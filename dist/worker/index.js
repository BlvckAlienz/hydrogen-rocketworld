...
function Index() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("h3", { children: "Welcome to Your Local Blvck Market!" }, void 0, !1, {
...
var redirect3 = function(url, init) {
  init === void 0 && (init = 302);
  let responseInit = init;
  typeof responseInit == "number" ? responseInit = {
    status: responseInit
...
var isBrowser3 = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u";
var UNSAFE_DEFERRED_SYMBOL2 = Symbol("deferred");

// node_modules/@remix-run/server-runtime/dist/esm/responses.js
var redirect5 = (url, init = 302) => redirect3(url, init);
...
var warnings2 = /* @__PURE__ */ new Set(), warnOnce2 = (string) => {
...
var assets_manifest_default = { version: "9a433ac4", entry: { module: "/build/entry.client-LMNYETXJ.js", imports: ["/build/_shared/chunk-QP5E6Q62.js", "/build/_shared/chunk-AQO2IFES.js", "/build/_shared/chunk-5KL4PAQL.js"] }, routes: { root: { id: "root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/root-N7R2I32G.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "routes/_index": { id: "routes/_index", parentId: "root", path: void 0, index: !0, caseSensitive: void 0, module: "/build/routes/_index-Q7ZZRGX4.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/routes/graphiql": { id: "virtual-routes/routes/graphiql", parentId: "virtual-routes/virtual-root", path: "graphiql", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/routes/graphiql-YNBPX2VW.js", imports: void 0, hasAction: !1, hasLoader: !0, hasCatchBoundary: !1, hasErrorBoundary: !1 }, "virtual-routes/virtual-root": { id: "virtual-routes/virtual-root", parentId: void 0, path: "", index: void 0, caseSensitive: void 0, module: "/build/virtual-routes/virtual-root-RQCUNP3K.js", imports: void 0, hasAction: !1, hasLoader: !1, hasCatchBoundary: !1, hasErrorBoundary: !1 } }, cssBundleHref: void 0, hmr: void 0, url: "/build/manifest-9A433AC4.js" };
...
var alreadyWarned3 = {};
function warnOnce3(condition, message) {
...
function warnOnceAboutExpiresCookie(name, expires) {
  warnOnce3(!expires, `The "${name}" cookie has an "expires" property set. This will cause the expires value to not be updated when the session is committed. Instead, you should set the expires value when serializing the cookie. You can use \`commitSession(session, { expires })\` if using a session storage object, or \`cookie.serialize("value", { expires })\` if you're using the cookie directly.`);
}
...
// node_modules/@shopify/remix-oxygen/node_modules/@remix-run/server-runtime/dist/esm/responses.js
var json5 = (data, init = {}) => json(data, init);
var redirect6 = (url, init = 302) => redirect(url, init);
...
async function callRouteActionRR({
  ...
  return isResponse2(result) ? result : json5(result);
}
async function callRouteLoaderRR({
  ...
  return isDeferredData2(result) ? result.init && isRedirectStatusCode(result.init.status || 200) ? redirect6(new Headers(result.init.headers).get("Location"), result.init) : result : isResponse2(result) ? result : json5(result);
}
...
async function handleDataRequestRR(serverMode, staticHandler, routeId, request, loadContext) {
  try {
    ...
    return logServerErrorIfNotAborted(errorInstance, request, serverMode), json5(serializeError(errorInstance, serverMode), {
      status,
      headers: {
        "X-Remix-Error": "yes"
      }
...
function warnOnceAboutSigningSessionCookie(cookie) {
  warnOnce3(cookie.isSigned, `The "${cookie.name}" cookie is not signed, but session cookies should be signed to prevent tampering on the client before they are sent back to the server. See https://remix.run/utils/cookies#signing-cookies for more information.`);
}
